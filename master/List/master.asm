...
_0x0:
	.DB  0x54,0x57,0x49,0x4E,0x54,0x0,0x25,0x64
	.DB  0x0,0x73,0x74,0x61,0x72,0x74,0x0,0x53
	.DB  0x4C,0x41,0x5F,0x57,0x0,0x44,0x41,0x54
	.DB  0x41,0x0,0x53,0x54,0x4F,0x50,0x0,0x44
	.DB  0x41,0x54,0x41,0x20,0x41,0x43,0x4B,0x20
	.DB  0x72,0x20,0x65,0x72,0x72,0x6F,0x72,0x0
	.DB  0x53,0x4C,0x41,0x20,0x41,0x43,0x4B,0x20
	.DB  0x72,0x20,0x65,0x72,0x72,0x6F,0x72,0x0
	.DB  0x73,0x74,0x20,0x74,0x20,0x65,0x72,0x72
	.DB  0x6F,0x72,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0039 // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=Out Func1=Out Func0=Out
; 0000 003A // State7=T State6=T State5=T State4=T State3=T State2=0 State1=0 State0=0
...
; 0000 0091 // Bit Rate: 400.000 kHz
; 0000 0092 TWBR=0x02;
	LDI  R30,LOW(2)
	OUT  0x0,R30
; 0000 0093 // Two Wire Bus Slave Address: 0x1
; 0000 0094 // General Call Recognition: On
; 0000 0095 TWAR=0x03;
	LDI  R30,LOW(3)
	OUT  0x2,R30
; 0000 0096 // Generate Acknowledge Pulse: On
; 0000 0097 // TWI Interrupt: On
; 0000 0098 TWCR=0x45;
	LDI  R30,LOW(69)
	OUT  0x36,R30
; 0000 0099 TWSR=0x00;
...
; 0000 009C // Connections specified in the
...
; 0000 00B0       if(flag){
	...
	BRNE PC+3
	JMP _0x7
; 0000 00B1         //start transmite
; 0000 00B2         TWCR = (1<<TWINT) | (1<<TWSTA) | (1<<TWEN);
	LDI  R30,LOW(164)
	OUT  0x36,R30
; 0000 00B3         //TWCR = 1<<7   , 5   2
; 0000 00B4         //TWCR = 0b00100100;
; 0000 00B5         lcd_clear();
	CALL _lcd_clear
; 0000 00B6         sprintf(a,"%d",TWCR);
	LDI  R30,LOW(_a)
	LDI  R31,HIGH(_a)
	ST   -Y,R31
	ST   -Y,R30
	...
	CALL _sprintf
	ADIW R28,8
; 0000 00B7         lcd_puts("start");
	__POINTW1MN _0x8,0
	CALL SUBOPT_0x0
; 0000 00B8         lcd_puts(a);
	LDI  R30,LOW(_a)
	LDI  R31,HIGH(_a)
	CALL SUBOPT_0x0
; 0000 00B9         //
; 0000 00BA         while(!(TWCR & (1<<TWINT)));
_0x9:
	IN   R30,0x36
	ANDI R30,LOW(0x80)
	BREQ _0x9
; 0000 00BB         //start transmition check
; 0000 00BC         if(TWSR & 0x08){
	SBIS 0x1,3
	RJMP _0xC
; 0000 00BD             //SLA transmite
; 0000 00BE             TWDR = SLA_W;
	OUT  0x3,R5
; 0000 00BF             TWCR = (1<<TWINT) | (1<<TWEN);
	LDI  R30,LOW(132)
	OUT  0x36,R30
; 0000 00C0             lcd_clear();
	CALL _lcd_clear
; 0000 00C1             lcd_puts("SLA_W");
	__POINTW1MN _0x8,6
	CALL SUBOPT_0x0
; 0000 00C2             //
; 0000 00C3             while(!(TWCR & (1<<TWINT)));
_0xD:
	IN   R30,0x36
	ANDI R30,LOW(0x80)
	BREQ _0xD
; 0000 00C4             //ack receive check
; 0000 00C5             if(TWSR & 0x18){
	IN   R30,0x1
	ANDI R30,LOW(0x18)
	BREQ _0x10
; 0000 00C6                 //data transmite
; 0000 00C7                 TWDR = DATA;
	OUT  0x3,R7
; 0000 00C8                 TWCR = (1<<TWINT) | (1<<TWEN);
	LDI  R30,LOW(132)
	OUT  0x36,R30
; 0000 00C9                 lcd_clear();
	CALL _lcd_clear
; 0000 00CA                 lcd_puts("DATA");
	__POINTW1MN _0x8,12
	CALL SUBOPT_0x0
; 0000 00CB                 //
; 0000 00CC                 while(!(TWCR & (1<<TWINT)));
_0x11:
	IN   R30,0x36
	ANDI R30,LOW(0x80)
	BREQ _0x11
; 0000 00CD                 //ack receive check
; 0000 00CE                 if(TWSR & 0x28){
	IN   R30,0x1
	ANDI R30,LOW(0x28)
	BREQ _0x14
; 0000 00CF                     //stop transmite
; 0000 00D0                     TWCR = (1<<TWINT) | (1<<TWEN) | (1<<TWSTO);      \
; 0000 00D1                     lcd_clear();
	LDI  R30,LOW(148)
	OUT  0x36,R30
	CALL _lcd_clear
; 0000 00D2                     lcd_puts("STOP");
	__POINTW1MN _0x8,17
	CALL SUBOPT_0x0
; 0000 00D3                     flag = 0;
	__GETWRN 16,17,0
; 0000 00D4                 }else{
	RJMP _0x15
_0x14:
; 0000 00D5                     lcd_puts("DATA ACK r error");
	__POINTW1MN _0x8,22
	CALL SUBOPT_0x0
; 0000 00D6                 }
_0x15:
; 0000 00D7             }else{
	RJMP _0x16
_0x10:
; 0000 00D8                 lcd_puts("SLA ACK r error");
	__POINTW1MN _0x8,39
	CALL SUBOPT_0x0
; 0000 00D9             }
_0x16:
